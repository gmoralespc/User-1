...
use Lavalite\User\Exceptions\NameRequiredException;
use Lavalite\User\Exceptions\GroupExistsException;
...
class Group extends Model implements GroupInterface {
	 ...
	 * @var string
	 */
	protected static $userModel = 'Lavalite\User\Models\User';
	 ...
	 *
	 * @return bool
	 * @throws \Lavalite\User\Exceptions\NameRequiredException
	 * @throws \Lavalite\User\Exceptions\GroupExistsException
	 */
