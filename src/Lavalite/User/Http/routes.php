...
Route::group(array('prefix' => 'admin'), function () {
    ...
    Route::get('/user/profile', 'Lavalite\User\Http\Controllers\PermissionAdminController@getProfile');
    Route::post('/user/profile', 'Lavalite\User\Http\Controllers\PermissionAdminController@postProfile');
